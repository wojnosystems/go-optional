...
func (b Bool) ValueWithOK() (value bool, ok bool) {
...
func (b Int64) ValueWithOK() (value int64, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Byte) ValueWithOK() (value byte, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Rune) ValueWithOK() (value rune, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Float64) ValueWithOK() (value float64, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Complex64) ValueWithOK() (value complex64, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Int32) ValueWithOK() (value int32, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Int8) ValueWithOK() (value int8, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Float32) ValueWithOK() (value float32, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Uintptr) ValueWithOK() (value uintptr, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Int) ValueWithOK() (value int, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Uint) ValueWithOK() (value uint, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Uint64) ValueWithOK() (value uint64, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Uint32) ValueWithOK() (value uint32, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Uint16) ValueWithOK() (value uint16, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Uint8) ValueWithOK() (value uint8, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b String) ValueWithOK() (value string, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Complex128) ValueWithOK() (value complex128, ok bool) {
	return b.Value(), b.state.IsPresent()
}
...
func (b Int16) ValueWithOK() (value int16, ok bool) {
	return b.Value(), b.state.IsPresent()
}
